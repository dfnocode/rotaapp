...
<div id="myNovoCliente" class="sidenav">
    ...
    <div class="ui-dialog-titlebar"><span class="ui_titulo">Adicionar Novo Usuário</span><button title='Fechar Janela'
            ...
            <div class="row">
                ...
                <div class="col-md-6 situacao-label">
                    <div class="form-group">
                        ...
                        <select name="tipo_usuario_newcliente" id="tipo_usuario_newcliente"
                            class="form-control">
