...
for (var i = 1; i < table.rows.length; i++) {
    table.rows[i].onclick = function() {
        ...
        document.getElementById("tipo_usuario_cliente").options[0].text = this.cells[2].innerHTML;
        document.getElementById("tipo_usuario_cliente").options[0].value = this.cells[2].innerHTML;

        //document.getElementById("registro_cliente").value = '2021-04-01';
        var registro = this.cells[3].innerHTML;
        ...
        var emailClient = this.cells[5].innerHTML;
        ...
        var docClient = this.cells[7].innerHTML;
        ...
        document.getElementById("cnpj_cliente").value = this.cells[7].innerHTML;
        document.getElementById("cpf_cliente").value = this.cells[7].innerHTML;
        document.getElementById("idrg_cliente").value = this.cells[8].innerHTML;
        document.getElementById("endereco_cliente").value = this.cells[10].innerHTML;

        document.getElementById("numero_cliente").value = this.cells[11].innerHTML;
        document.getElementById("bairro_cliente").value = this.cells[12].innerHTML;
        document.getElementById("complemento_cliente").value = this.cells[13].innerHTML;
        document.getElementById("cidade_cliente").value = this.cells[14].innerHTML;

        document.getElementById("uf_cliente").options[0].text = this.cells[15].innerHTML;
        document.getElementById("uf_cliente").options[0].value = this.cells[15].innerHTML;

        document.getElementById("cep_cliente").value = this.cells[16].innerHTML;
        ...
        document.getElementById("contatos_cliente").value = this.cells[18].innerHTML;
        document.getElementById("celular_cliente").value = this.cells[19].innerHTML;
        document.getElementById("fax_cliente").value = this.cells[20].innerHTML;
        document.getElementById("website_cliente").value = this.cells[21].innerHTML;
        document.getElementById("obs_cliente").value = this.cells[22].innerHTML;
        document.getElementById("emailnfe_cliente").value = this.cells[23].innerHTML;
