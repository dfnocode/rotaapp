...
<?php
    ...
    $id_periodo = $_POST['id_perio_lista'];
?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Períodos Cadastrados</h3>
                                    ...
                                    <form id="lista" action="." method="POST">
                                        <table id="tbl_periodos" class="table table-head-fixed text-nowrap">
                                            ...
                                            <tbody>
                                            <input type="hidden" name="id_perio_lista" id="id_periodo_lista" value="">
                                            <?php
                                                $path = dirname(__FILE__);
                                                $path .= '/listaPeriodos.php';
                                                include_once($path);
                                                
                                                while($rows = mysqli_fetch_array($resultPeriodos, MYSQLI_ASSOC)) : 
                                            ?>
                                                <tr>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Tarifas do período </h3>
                                        <div class="card-tools">
