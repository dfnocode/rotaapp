...
<div id="mySidenav" class="sidenav">
    ...
    <form action="" id="update_cliente" name="update_cliente" method="POST" class="form-horizontal editar_cliente">
        <div class="modal-body">
            ...
            <div class="row">
                <input type="hidden" name="id_cliente_edit" id="id_cliente_edit" value="<?php echo $user_id; ?>">
                <?php 
                ...
                <div class="col-md-12 situacao-label">
                    <label>Situação -
                        <?php echo $user_situacao; ?>
                    </label><br>
                    <div class="group-item-form">
                        <label class="radio-inline" id="sit1">
                            <input type="radio" name="optradio_cliente" id="sit1" value="Ativo" <?php echo $op1; ?>>
                            &nbsp;Ativo
                        </label>
                        <label class="radio-inline" id="sit2">
                            <input type="radio" name="optradio_cliente" id="sit2" value="Inativo" <?php echo $op2; ?>>
                            &nbsp;Inativo
                        </label>
                        <label class="radio-inline" id="sit3">
                            <input type="radio" name="optradio_cliente" id="sit3" value="Sem Movimento" <?php echo $op3;
                                ?>> &nbsp;Sem Movimento
                        </label>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email_cliente" id="email_cliente" class="form-control email_cliente"
                            ...
                            <script language="javascript">
                                ...
                                email.blur(function() {
                                    var emailSalvo = $("#email_cliente2").val();
                                    var emailBusca = email.val();                                    
                                    if (emailSalvo != emailBusca) {
                                        //alert (emailBusca);
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                console.log(data);
                                                data = $.parseJSON(data);
                                                $("#resposta2").fadeIn(2000);
                                                $("#resposta2").text(data.email);
                                                
                                                //$("#resposta2").fadeOut(2000);                                                
                                                if(data.email != 'Ok!') {
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="cnpj_cliente" id="cnpj_cliente" class="cnpj form-control"
                            value="<?php if (strlen($user_cnpj) == 18) { echo $user_cnpj; } ?>"
                            style="<?php echo $mostra1; ?>">
                        <input type="text" name="cpf_cliente" id="cpf_cliente" class="cpf form-control"
                            value="<?php if (strlen($user_cnpj) == 14) { echo $user_cnpj; } ?>"
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" id="cep_cliente" name="cep_cliente" class="cep form-control" size="10"
                            maxlength="9" value="<?php echo $user_cep; ?>">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input type="text" name="complemento_cliente" id="complemento_cliente" class="form-control"
                            value="<?php echo $user_complemento; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="obs_cliente" id="obs_cliente"
                            class="form-control"><?php echo $user_obs; ?></textarea>
                    </div>
                </div>
