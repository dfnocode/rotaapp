            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                        <h3 class="card-title"><i class="fas fa-people-arrows mr-1"></i>Grupos de Comissão</h3>
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item" data-toggle="modal" data-target="#add_grupo">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table id="grupo_comissao" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Código</th>
                                    <th>Nome</th>
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT id, nome, calculo_base FROM tbl_grupoComissao";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['calculo_base']; ?> </td>
                                    <td>
                                        <button title='Editar' type='button' class='btn btn-warning copiar'
                                            data-toggle='modal' data-target='#edit_grupo'><i
