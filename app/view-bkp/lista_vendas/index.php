                           ...
                           if ($_SESSION['funcao'] == 'Vendedor') {
                            ...
                            ?>
                                ...
                                <tr role="row" class="even" data-id="<?php echo $row['Número']; ?>" style="cursor:hand">
                                    ...
                                    <td class="dpedido"><?php

                                    /* 
                                    //ATUALIZA TODOS OS PEDIDOS COM O NOVO VALOR DE PRODUTO ATUALIZADO
                                    ...
                                    $result2 = mysqli_query($conexao,$itens_pedido); 
                                    ...
                                    echo converteDinheiro($row['Total']);
                                    //echo converteDinheiro($row['Total']); 
