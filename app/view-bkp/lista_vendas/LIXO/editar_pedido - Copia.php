                                    ...
                                    <ul class="nav nav-pills ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <button title='Salvar' type='submit' class='btn btn-success float-right'><i
                                                    class='fas fa-save' id='salva-totais-pedido'> </i> Salvar</button>
                                        </li>
                                        &nbsp;
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group mb-3 input-group-sm">
                                                ...
                                                <input type="text" id="dFantasia" readonly="readonly" class="form-control"
 ...
 -->
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-2 col-md-4">
                                        ...
                                        <div class="input-group mb-3 input-group-mb">
                                            ...
                                            <input type="hidden" id="subTotalnDesc" name="subTotalnDesc" value="<?php echo $t_valor_itens; //if (isset($_GET['subTotalnDesc'])) { echo $_GET['subTotalnDesc']; } ?>" />
                                            <input type="text" id="t-valoritens" readonly="readonly"
                                                class="form-control" style="background-color: #dcf0eb; font-weight: bold;" value="<?php converteDinheiro($t_valor_itens); ?>" />
                                        </div>
                                    </div>
                                    
                                 
                                    <div class="form-group col-lg-2 col-md-4">
                                        <label for="totalDescItens">(&sum;) Descontos/Item <span class="fas fa-info-circle"
                                    ...
                                    <div class="form-group col-lg-2 col-md-4">
                                        ...
                                        <div class="input-group mb-3 input-group-xs">
                                            ...
                                            <input type="text" id="descAdicional" name="descAdicional"
                                                class="form-control"
                                                value="<?php converteDinheiro($desc2); ?>" />
                                        </div>
                                    </div>
                           ...
                           <!--          <div class="form-group col-lg-2 col-md-4">
                                        ...
                                        <div class="input-group mb-3 input-group-mb">
                                            <div class="input-group-prepend">
                                                <span
                                                    class="input-group-text"><?// $moeda = '<span class="tvaloritens">R$ '; echo $moeda; ?></span></span>
                                            </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-2 col-md-4">
                                        ...
                                        <input type="number" id="prazoEntrega" name="prazoEntrega" class="form-control"
                                            value="<?php if(isset($_GET['prazoEntrega'])) { echo $_GET['prazoEntrega']; } else {  echo "0"; } ?>" />
                                    </div>
                                    <div class="form-group col-lg-2 col-md-4">
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="input-group mb-3 input-group-xs">
                                            ...
                                            <input type="hidden" id="vTComs2" name="vTComs2"
                                                ...
                                                /* if(!isset($_GET['porComss'])) { 
                                                    ...
                                                    if(isset($_GET['vTComs2'])) { echo $_GET['vTComs2']; }
                                                }                       */                          
                                               /*  if(isset($_GET['vTComs2'])) { echo $_GET['vTComs2']; } else { converteDinheiro("0"); }  */?>">
                                            <input type="text" readonly="readonly" id="totalComissoes"
                                                name="totalComissoes" class="money-in form-control" value="
                                                <?php 
                                    ...
                                    <div class="form-group col-lg-2 col-md-3">
                                        <label for="dNum">(&sum;)Total Desconto da Venda <span class="fas fa-info-circle"
                                        ...
                                        <div class="input-group mb-3 input-group-mb">
                                            ...
                                            <input type="text" id="" readonly="readonly" class="form-control"
                                                value="
                                                <?php  
                                                //  TOTAL DESCONTOS  = sub (DESCONTOS/ITEM+Descontos+Taxas Adicionais+Frete
                                                    $TotalDescontos = $t_desc_itens;
                                                    if (isset($_GET['descAdicional'])) {
                                                        $TotalDescontos = sumTotalItem($TotalDescontos,$_GET['descAdicional']);
                                                    }         
                                                    if (isset($_GET['tx_add'])) {
                                                       //$TotalDescontos += $_GET['tx_add'];
                                                       $TotalDescontos = sumTotalItem($TotalDescontos,$_GET['tx_add']);
                                                    }
                                                    if (isset($_GET['valorFrete'])) {
                                                        //$TotalDescontos += $_GET['valorFrete'];
                                                        $TotalDescontos = sumTotalItem($TotalDescontos,$_GET['valorFrete']);
                                                    }
                                                                                          
                                                    converteDinheiro($TotalDescontos);
