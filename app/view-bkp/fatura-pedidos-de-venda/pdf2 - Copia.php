 ...
 // reference the Dompdf namespace
    ...
    <div class="card">
        <div class="card-header ui-sortable-handle">
            ...
            <h4>Número: <span style="color:#37A661;">
                    <?php echo $numero; ?>
                </span></h4>
                ...
                <ul class="nav nav-pills ml-auto">
                    ...
                    <li class="nav-item">
                        <form action="pdf-gen.php" method="POST">
                            ...
                            <button title='Imprimir - PDF' name='btn_pdf' type='submit'
                                class='btn btn-primary float-right'><i class='fas fa-print'></i><span
                                    class="btn-resp"></span></button>
                        </form>
                    </li>
                    &nbsp;
                    <li class="nav-item">
                        <a href="../lista_vendas/" class="btn btn-danger" type="button"
                            title="Voltar para Pedidos de Venda"><i class="fas fa-list"></i>
                            <span class="btn-resp"></span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../fatura-pedidos-de-venda/dom-html-pdf.php?num=<?php echo $numero; ?>"
                            class="btn btn-secondary" type="button" title="DOMPDF"><i class="fas fa-eye"></i>
                            <span class="btn-resp"></span></a>
                    </li>
                </ul>
            </div>
        ...
        <div class="card-header ui-sortable-handle">
            ...
            <div class="card-tools" style="margin-right: 10px;">
                <ul class="nav nav-pills ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="../lista_vendas/editar_pedido.php?numero=<?php echo $numero; ?>" alt='Editar Pedido'
                            title='Editar Pedido' type='button' class='btn btn-warning float-right'><i
