            ...
            <div class="row">
                ...
                <div class="col-md-12 situacao-label">
                    ...
                    <div class="group-item-form">
                        <label class="radio-inline" id="situacao1">
                            <input type="radio" name="optradio" <?php echo $op1; ?>> &nbsp;Ativo
                        </label>
                        <label class="radio-inline" id="situacao2">
                            <input type="radio" name="optradio" <?php echo $op2; ?>> &nbsp;Inativo
                        </label>
                        <label class="radio-inline" id="situacao3">
                            <input type="radio" name="optradio" <?php echo $op3; ?>> &nbsp;Sem Movimento
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_cliente" id="nome_cliente" class="form-control" value="<?php echo $user_name; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        ?>
                        <input type="date" name="registro_cliente" id="registro_cliente" class="form-control" value="<?php echo $user_registro; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="email_cliente" id="email_cliente" class="form-control" value="<?php echo $user_email; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputName">Telefone</label>
                        <input type="text" name="telefone_cliente" id="telefone_cliente" class="form-control" value="<?php echo $user_tel; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="cnpjcpf_cliente" id="cnpjcpf_cliente" class="cpf form-control" value="<?php echo $user_cnpj; ?>">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" id="cep_cliente" name="cep_cliente" class="form-control" size="10" maxlength="9" value="<?php echo $user_cep; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="uf_cliente" id="uf_cliente" class="form-control">
                            <option value="<?php echo $user_estado; ?>"> <?php echo $user_estado; ?></option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="celular_cliente" id="celular_cliente" class="form-control" value="<?php echo $user_celular; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputName">Website</label>
                        <input type="text" name="website_cliente" id="website_cliente" class="form-control" value="<?php echo $user_website; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="inputName">Fax</label>
                        <input type="text" name="fax_cliente" id="fax_cliente" class="form-control" value="<?php echo $user_fax; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="emailnfe_cliente" id="emailnfe_cliente" class="form-control" value="<?php echo $user_emailnfe; ?>">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="inputName">Contatos</label>
                        <input type="text" name="contatos_cliente" id="contatos_cliente" class="form-control" value="<?php echo $user_contatos; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="obs_cliente" id="obs_cliente" class="form-control"><?php echo $user_obs; ?></textarea>
                    </div>
                </div>
