            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header ui-sortable-handle" style="cursor: move;">
                        <h3 class="card-title"><i class="fas fa-people-arrows mr-1"></i>Fornecedores</h3>
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item" data-toggle="modal" data-target="#add_fornecedor">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table id="fornecedores" class="table table-bordered table-striped compact nowrap">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Ação</th>
                            ...
                            ?>
                               <tr>
                                    ...
                                    <td>
                                        <button title='Editar' type='button' class='btn btn-warning copiar' data-toggle='modal' data-target='#edit_fornecedor'>
