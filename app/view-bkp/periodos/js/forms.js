$(document).ready(function() {
    ...
    $("#add_").submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../../config/functions/insert_periodos.php",
            method: "post",
            data: $("form").serialize(),
            dataType: "text",
...
$(document).ready(function() {
    ...
    $("#add_tarifa").submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../../config/functions/insert_tarifa_periodo.php",
            method: "post",
            data: $("form").serialize(),
            dataType: "text",
            success: function(strMessage) {
...
$(document).ready(function() {
    ...
    $("#delete_").submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../../config/functions/delete_periodos.php",
            method: "post",
            data: $("form").serialize(),
            dataType: "text",
            success: function(strMessage) {
...
$(document).ready(function() {
    ...
    $("#delete_tarifa").submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../../config/functions/delete_tarifaPeriodo.php",
            method: "post",
            data: $("form").serialize(),
            dataType: "text",
            success: function(strMessage) {
...
$(document).ready(function() {
    ...
    $("#update_").submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../../config/functions/update_periodos.php",
            method: "post",
            data: $("form").serialize(),
            dataType: "text",
            success: function(strMessage) {
