...
// Adiciona o arquivo class.phpmailer.php - você deve especificar corretamente o caminho da pasta com o este arquivo.
 ...
 $mail->Host = "mail.rotarepresenta.com.br"; // Seu endereço de host SMTP
 ...
 $mail->Password = 'm6Z3ah5+.it+'; // Senha da sua conta de email
 // DADOS DO REMETENTE
 ...
 $mail->AddAddress('dfno82@gmail.com'); // Define qual conta de email receberá a mensagem
 ...
 $mail->Body .= "TESTE";
 $mail->addAttachment('pedido-8008.pdf');
// Texto da mensagem
 // ENVIO DO EMAIL
